...
namespace HypervCsiDriver.UnitTests
{
    ...
    public sealed class HypervNodeTests : IClassFixture<HypervNodeFixture>
    {
        ...
        [Theory]
        [InlineData("hyperv-04", "ea0bf947-27d7-4d85-b23b-987e9c2393f2")]
        ...
        [Theory]
        [InlineData("hyperv-04", "/dev/sdb", "/notexist", false)]
        ...
        public async Task RemoteExitCode()
        {
            ...
            var connectionInfo = new SSHConnectionInfo("k8s", "hyperv-04", null);
